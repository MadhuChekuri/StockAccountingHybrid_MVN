...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Exception{
		...
		if(utilities.PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid_MVN\\drivers\\chromedriver.exe");
		    driver=new ChromeDriver();
		}else if(utilities.PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")){
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid_MVN\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else if(utilities.PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
			System.setProperty("webdriver.internetexplorer.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid_MVN\\drivers\\IEDriverServer.exe");
	...
	public static void openApplication(WebDriver driver) throws Exception{	
		driver.get(utilities.PropertyFileUtil.getValueForKey("url"));
	...
	public static void captureData(WebDriver driver,String locatortytpe,
		...
		FileWriter fw=new FileWriter("C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid_MVN\\CaptureData\\suppnumber.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Exception{
		FileReader fr=new FileReader("C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid_MVN\\CaptureData\\suppnumber.txt");
